...
export declare class V2NIMSettingService extends NIMEBaseServiceClass<V2NIMSettingListener> {
     ...
     * @example
     * ```ts
     * const isMuted = nim.V2NIMSettingService.getConversationMuteStatus("conversationId")
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMSettingService.setTeamMessageMuteMode("teamId", 1, 1)
     * ```
     */
     ...
     * @example
     * ```ts
     * const muteModes = await nim.V2NIMSettingService.getAllTeamMessageMuteMode(1)
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMSettingService.setP2PMessageMuteMode("accountId1", 1)
     * ```
     */
     ...
     * @example
     * ```ts
     * const muteMode = nim.V2NIMSettingService.getP2PMessageMuteMode("accountId1")
     * ```
     */
     ...
     * @example
     * ```ts
     * const muteList = await nim.V2NIMSettingService.getP2PMessageMuteList()
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMSettingService.setAppBackground(true, 0)
     * ```
     */
     ...
     * @example
     * ```ts
     * nim.V2NIMSettingService.setOfflinePushConfig(pushPlugin, { apns: { certificateName: "cert" } })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMSettingService.setPushMobileOnDesktopOnline(true)
     * ```
     */
     ...
     * @example
     * ```ts
     * const need = await nim.V2NIMSettingService.getPushMobileOnDesktopOnline()
     * ```
     */
