...
export interface UserServiceInterface {
     ...
     * @example
     * ```ts
     * await nim.user.setBlack({ account: 'accid1', isAdd: true })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.user.setMute({ account: 'accid1', isAdd: true })
     * ```
     */
     ...
     * @example
     * ```ts
     * const cards = await nim.user.getUsersNameCardFromServer({ accounts: ['accid1', 'accid2'] })
     * ```
     */
     ...
     * @example
     * ```ts
     * const card = await nim.user.updateMyNameCard({ nick: '昵称', avatar: 'https://example.com/avatar.png' })
     * ```
     */
     ...
     * @example
     * ```ts
     * const relations = await nim.user.getRelations()
     * ```
     */
     ...
     * @example
     * ```ts
     * const blacklist = await nim.user.getBlackList()
     * ```
     */
