...
export interface TeamServiceInterface {
     ...
     * @example
     * ```ts
     * const team = await nim.team.getTeamInfo({ teamId: '12345' })
     * ```
     */
    getTeamInfo(options: {
        teamId: string;
     ...
     * @example
     * ```ts
     * const result = await nim.team.getTeamsById({ teamIds: ['12345', '67890'] })
     * ```
     */
     ...
     * @example
     * ```ts
     * const team = await nim.team.createTeam({
     *   type: 'advanced',
     *   name: '我的群',
     ...
     * @example
     * ```ts
     * await nim.team.dismissTeam({ teamId: '12345' })
     * ```
     */
    dismissTeam(options: {
        teamId: string;
     ...
     * @example
     * ```ts
     * await nim.team.leaveTeam({ teamId: '12345' })
     * ```
     */
    leaveTeam(options: {
        teamId: string;
     ...
     * @example
     * ```ts
     * await nim.team.transferTeam({ teamId: '12345', account: 'newOwnerId', leave: false })
     * ```
     */
     ...
     * @example
     * ```ts
     * const updatedTeam = await nim.team.updateTeamInfo({
     *   teamId: '12345',
     *   name: '新的群名称',
     *   intro: '群简介'
     * })
     ...
     * @example
     * ```ts
     * const members = await nim.team.getTeamMembers({ teamId: '12345' })
     * ```
     */
     ...
     * @example
     * ```ts
     * const mutedMembers = await nim.team.getMutedTeamMembers({ teamId: '12345' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.team.addTeamMembers({ teamId: '12345', accounts: ['accid1', 'accid2'] })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.team.removeTeamMembers({ teamId: '12345', accounts: ['accid1'] })
     * ```
     */
     ...
     * @example
     * ```ts
     * const team = await nim.team.applyTeam({ teamId: '12345', ps: '申请加入群' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.team.addTeamManagers({ teamId: '12345', accounts: ['accid1', 'accid2'] })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.team.removeTeamManagers({ teamId: '12345', accounts: ['accid1'] })
     * ```
     */
     ...
     * @example
     * ```ts
     * const member = await nim.team.updateMyMemberInfo({
     *   teamId: '12345',
     *   nickInTeam: '我的群昵称',
     *   muteTeam: false
     * })
     ...
     * @example
     * ```ts
     * const member = await nim.team.updateMemberNick({
     *   teamId: '12345',
     *   account: 'accid1',
     *   nickInTeam: '新群昵称'
     * })
     ...
     * @example
     * ```ts
     * const result = await nim.team.getTeamMemberInvitorAccid({
     *   teamId: '12345',
     *   accounts: ['accid1', 'accid2']
     * })
     * ```
     ...
     * @example
     * ```ts
     * await nim.team.muteTeam({ teamId: '12345', type: 'all' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.team.passTeamApply({ teamId: '12345', from: 'applicantAccid', idServer: '123456' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.team.rejectTeamApply({ teamId: '12345', from: 'applicantAccid', idServer: '123456', ps: '拒绝原因' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.team.acceptTeamInvite({ teamId: '12345', from: 'inviterAccid', idServer: '123456' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.team.rejectTeamInvite({ teamId: '12345', from: 'inviterAccid', idServer: '123456', ps: '拒绝原因' })
     * ```
     */
...
export interface Team {
     ...
     *
     * noVerify: Verification not required.
     * needVerify: Verification required before a person joins the group.
