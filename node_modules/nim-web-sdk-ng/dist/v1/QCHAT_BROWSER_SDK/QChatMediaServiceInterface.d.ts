...
export interface QChatMediaServiceInterface {
     ...
     * @example
     * ```ts
     * await qchat.qchatMedia.muteAudio({ accid: 'user-account' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await qchat.qchatMedia.unMuteAudio({ accid: 'user-account' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await qchat.qchatMedia.startScreenShare()
     * ```
     */
     ...
     * @example
     * ```ts
     * await qchat.qchatMedia.stopScreenShare()
     * ```
     */
