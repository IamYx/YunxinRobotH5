...
export interface IBaseUploadFileOptions {
     ...
     *
     * If the host runtime does not support file size inspection, make your judgment after selecting the file and refer to APIs such as “wx.chooseImage” and “uni.chooseImage”.
     * @locale
     */
    maxSize?: number;
    /**
