...
export declare class V2NIMLoginService extends NIMEBaseServiceClass<V2NIMLoginListener> {
     ...
     * @example
     * ```ts
     * const addresses = await nim.V2NIMLoginService.getChatroomLinkAddress("roomId", false)
     * ```
     */
     ...
     * @example
     * ```ts
     * const status = nim.V2NIMLoginService.getLoginStatus()
     * ```
     */
     ...
     * @example
     * ```ts
     * const status = nim.V2NIMLoginService.getConnectStatus()
     * ```
     */
     ...
     * @example
     * ```ts
     * const syncDetails = nim.V2NIMLoginService.getDataSync()
     * ```
     */
     ...
     * @example
     * ```ts
     * const clients = nim.V2NIMLoginService.getLoginClients()
     * ```
     */
     ...
     * @example
     * ```ts
     * const client = nim.V2NIMLoginService.getCurrentLoginClient()
     * ```
     */
     ...
     * @example
     * ```ts
     * nim.V2NIMLoginService.setReconnectDelayProvider((delay) => delay * 2)
     * ```
     */
     ...
     * @example
     * ```ts
     * nim.V2NIMLoginService.setAppVisibility(true)
     * ```
     */
...
export declare type V2NIMLoginOption = {
    ...
    /**
     * 是否为机器人账号登录。默认为 false（非机器人账号）。
     *
     * 注: 为 true 时，登录协议 aiBot 字段传 2，服务端可据此识别机器人账号连接。
     */
    aiBot?: boolean;
};
