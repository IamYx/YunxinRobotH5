...
export declare class V2NIMStorageService {
     ...
     * @example
     * ```ts
     * const scene = nim.V2NIMStorageService.addCustomStorageScene("custom", 86400 * 30)
     * ```
     */
     ...
     * @example
     * ```ts
     * const scenes = nim.V2NIMStorageService.getStorageSceneList()
     * ```
     */
     ...
     * @example
     * ```ts
     * const task = nim.V2NIMStorageService.createUploadFileTask({ fileObj: file })
     * ```
     */
     ...
     * @example
     * ```ts
     * const url = await nim.V2NIMStorageService.uploadFile(task, (progress) => console.log(progress))
     * ```
     */
     ...
     * @example
     * ```ts
     * const metaInfo = await nim.V2NIMStorageService.uploadFileWithMetaInfo(task, (progress) => console.log(progress))
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMStorageService.cancelUploadFile(task)
     * ```
     */
     ...
     * @example
     * ```ts
     * const longUrl = await nim.V2NIMStorageService.shortUrlToLong("https://nim.nosdn.127.net/short")
     * ```
     */
     ...
     * @example
     * ```ts
     * const result = await nim.V2NIMStorageService.getImageThumbUrl(attachment, { width: 100, height: 100 })
     * ```
     */
     ...
     * @example
     * ```ts
     * const result = await nim.V2NIMStorageService.getVideoCoverUrl(attachment, { width: 100, height: 100 })
     * ```
     */
