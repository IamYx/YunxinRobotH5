...
export declare class V2NIMConversationGroupService extends NIMEBaseServiceClass<V2NIMConversationGroupListener> {
     ...
     * @example
     * ```ts
     * await nim.V2NIMConversationGroupService.updateConversationGroup('GROUP_ID', 'NEW_NAME')
     * ```
     */
     ...
     * @example
     * ```ts
     * const results = await nim.V2NIMConversationGroupService.addConversationsToGroup('GROUP_ID', [conversationId])
     * ```
     */
     ...
     * @example
     * ```ts
     * const results = await nim.V2NIMConversationGroupService.removeConversationsFromGroup('GROUP_ID', [conversationId])
     * ```
     */
     ...
     * @example
     * ```ts
     * const groups = await nim.V2NIMConversationGroupService.getConversationGroupList()
     * ```
     */
     ...
     * @example
     * ```ts
     * const groups = await nim.V2NIMConversationGroupService.getConversationGroupListByIds(['GROUP_ID1', 'GROUP_ID2'])
     * ```
     */
