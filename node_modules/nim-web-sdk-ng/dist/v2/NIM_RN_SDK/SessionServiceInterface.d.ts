...
export interface SessionServiceInterface {
     ...
     * @example
     * ```ts
     * await nim.session.resetSessionUnreadCount({ id: 'p2p-accid1' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.session.resetMultiSessionUnreadCount({
     *   sessionIds: ['p2p-accid1', 'team-12345']
     * })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.session.deleteSession({ id: 'p2p-accid1', isSyncToServer: true })
     * ```
     */
     ...
     * @example
     * ```ts
     * nim.session.deleteAllSessionsFromLocal()
     * ```
     */
     ...
     * @example
     * ```ts
     * const session = await nim.session.addStickTopSession({
     *   id: 'p2p-accid1',
     *   ext: '置顶扩展字段'
     * })
     * ```
     ...
     * @example
     * ```ts
     * const session = await nim.session.deleteStickTopSession({ id: 'p2p-accid1' })
     * ```
     */
     ...
     * @example
     * ```ts
     * const session = await nim.session.updateStickTopSession({
     *   id: 'p2p-accid1',
     *   ext: '更新后的置顶扩展字段'
     * })
     * ```
