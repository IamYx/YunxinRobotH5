...
export declare const V2NIMErrorCode: {
    ...
    V2NIM_ERROR_CODE_ACCOUNT_ALREADY_EXISTS: number;
    ...
    V2NIM_ERROR_CODE_BOT_SDK_NEED_AI_BOT_ACCOUNT: number;
    V2NIM_ERROR_CODE_NOT_AI_BOT_ACCOUNT: number;
    V2NIM_ERROR_CODE_AI_BOT_BIND_CODE_NOT_EXIST: number;
    ...
    V2NIM_ERROR_CODE_AI_BOT_AND_USER_INVISIBLE: number;
