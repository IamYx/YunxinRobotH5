...
export declare class V2NIMTeamService extends NIMEBaseServiceClass<V2NIMTeamListener> {
     ...
     * @example
     * ```ts
     * await nim.V2NIMTeamService.updateTeamMemberNickEx("123456", 1, {
     ...
     * @example
     * ```ts
     * await nim.V2NIMTeamService.clearAllTeamJoinActionInfoEx({
     *   timestamp: Date.now(),
     *   type: 3
     * })
     * ```
     ...
     * @example
     * ```ts
     * await nim.V2NIMTeamService.deleteTeamJoinActionInfo({
     *   teamId: "123456",
     *   teamType: 1,
     *   operatorAccountId: "accountId1",
     *   actionType: 0
     ...
     * @example
     * ```ts
     * const count = await nim.V2NIMTeamService.getTeamJoinActionInfoUnreadCount()
     * ```
     */
     ...
     * @example
     * ```ts
     * const teams = await nim.V2NIMTeamService.searchTeamByKeyword("关键字")
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMTeamService.addTeamMembersFollow("123456", 1, ["accountId1", "accountId2"])
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMTeamService.removeTeamMembersFollow("123456", 1, ["accountId1", "accountId2"])
     * ```
     */
