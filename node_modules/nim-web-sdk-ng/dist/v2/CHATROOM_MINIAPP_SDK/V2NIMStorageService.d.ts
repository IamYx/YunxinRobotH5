...
export interface V2NIMStorageService extends NIMEBaseServiceInterface<V2NIMStorageListener> {
     ...
     * @example
     * ```ts
     * const scene = chatroom.V2NIMStorageService.addCustomStorageScene('my-scene', 86400 * 7)
     * ```
     */
     ...
     * @example
     * ```ts
     * const scenes = chatroom.V2NIMStorageService.getStorageSceneList()
     * ```
     */
     ...
     * @example
     * ```ts
     * const task = chatroom.V2NIMStorageService.createUploadFileTask({
     ...
     * @example
     * ```ts
     * const task = chatroom.V2NIMStorageService.createUploadFileTask({ fileObj: file })
     * const url = await chatroom.V2NIMStorageService.uploadFile(task, (progress) => {
     ...
     * @example
     * ```ts
     * const task = chatroom.V2NIMStorageService.createUploadFileTask({ fileObj: imageFile })
     * const metaInfo = await chatroom.V2NIMStorageService.uploadFileWithMetaInfo(task, () => {})
     * console.log(metaInfo.url, metaInfo.width, metaInfo.height)
     * ```
     */
     ...
     * @example
     * ```ts
     * await chatroom.V2NIMStorageService.cancelUploadFile(task)
     * ```
     */
     ...
     * @example
     * ```ts
     * const longUrl = await chatroom.V2NIMStorageService.shortUrlToLong('https://short.url/abc')
     * ```
     */
     ...
     * @example
     * ```ts
     * const result = await chatroom.V2NIMStorageService.getImageThumbUrl(
     *   message.attachment,
     ...
     * @example
     * ```ts
     * const result = await chatroom.V2NIMStorageService.getVideoCoverUrl(
