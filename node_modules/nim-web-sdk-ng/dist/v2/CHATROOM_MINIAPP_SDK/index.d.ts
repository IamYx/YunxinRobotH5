...
import { V2NIMConnectionInfo } from './V2NIMStatisticsService';
...
export interface V2NIMChatroomClientListener {
     ...
     * 请求 LBS 的记录
     */
    onChatroomLbsSingleRequestRecord: [result: Record<string, any> | null, error?: V2NIMError];
    /**
     * 建立长连接结果记录
     */
    onChatroomConnectRecord: [connectionInfo: V2NIMConnectionInfo, error?: V2NIMError];
}
...
export * from './V2NIMStatisticsService';
