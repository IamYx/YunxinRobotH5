...
export declare class V2NIMUserService extends NIMEBaseServiceClass<V2NIMUserListener> {
     ...
     * @example
     * ```ts
     * const users = await nim.V2NIMUserService.getUserList(["accountId1", "accountId2"])
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMUserService.updateSelfUserProfile({ name: "新昵称", sign: "个性签名" })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMUserService.addUserToBlockList("accountId1")
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.V2NIMUserService.removeUserFromBlockList("accountId1")
     * ```
     */
     ...
     * @example
     * ```ts
     * const result = await nim.V2NIMUserService.checkBlock(["accountId1", "accountId2"])
     ...
     * @example
     * ```ts
     * const users = await nim.V2NIMUserService.searchUserByOption({ keyword: "关键词" })
     * ```
     */
