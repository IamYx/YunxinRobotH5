...
export declare class SignalingServiceInterface extends NIMEBaseServiceClass<NIMESignalingEventInterface> {
     ...
     * @example
     * ```ts
     * const channel = await nim.signaling.callEx({
     *   channelName: 'video-call-room',
     *   type: 1,
     *   uid: 'caller-uid',
     *   inviteeAccountId: 'callee-account'
     * })
     * ```
     */
     ...
     * @example
     * ```ts
     * const channel = await nim.signaling.joinAndAccept({
     *   channelId: 'channel-123',
     *   accountId: inviteEvent.accountId,
     *   requestId: inviteEvent.requestId
     * })
     * ```
     */
     ...
     * @example
     * ```ts
     * const channel = await nim.signaling.create({
     ...
     * @example
     * ```ts
     * await nim.signaling.close({ channelId: 'channel-123' })
     * ```
     */
     ...
     * @example
     * ```ts
     * const channelInfo = await nim.signaling.queryInfo({ channelName: 'my-channel' })
     * ```
     */
     ...
     * @example
     * ```ts
     * const channel = await nim.signaling.join({
     *   channelId: 'channel-123',
     *   uid: 'my-uid'
     * })
     * ```
     ...
     * @example
     * ```ts
     * await nim.signaling.leave({ channelId: 'channel-123' })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.signaling.invite({
     *   channelId: 'channel-123',
     *   inviteeAccountId: 'target-user'
     * })
     * ```
     */
     ...
     * @example
     * ```ts
     * await nim.signaling.cancelInvite({
     *   channelId: 'channel-123',
     *   inviteeAccountId: 'target-user',
     *   requestId: 'req-123'
     * })
     ...
     * @example
     * ```ts
     * await nim.signaling.reject({
     *   channelId: inviteEvent.channelId,
     *   accountId: inviteEvent.accountId,
     *   requestId: inviteEvent.requestId
     * })
     * ```
     ...
     * @example
     * ```ts
     * await nim.signaling.sendCustomCommand({
     *   channelId: 'channel-123',
     *   toAccountId: 'target-user',
     *   customInfo: JSON.stringify({ action: 'mute' })
     * })
     * ```
     */
